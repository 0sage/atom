...
from atom.command.builtin import (
    build_help_text,
    builtin_command_palette,
    cmd_evaluator_prompt,
)
from atom.command.router import CommandContext
from atom.utils.evaluator import default_evaluator_prompt
...
async def test_evaluator_prompt_reports_default_prompt(tmp_path) -> None:
    ...
    assert "Heartbeat evaluator prompt: atom default" in out.content
...
async def test_evaluator_prompt_handles_undecodable_existing_prompt(tmp_path) -> None:
    ...
    assert "Heartbeat evaluator prompt: atom default" in status.content
