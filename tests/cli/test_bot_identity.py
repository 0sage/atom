...
def test_bot_name_and_icon_defaults_match_atom_branding() -> None:
    """Defaults are atom's own name and mark, not the upstream cat."""
    defaults = AgentDefaults()

    assert defaults.bot_name == "atom"
    assert defaults.bot_icon == __logo__ == "[•]"
