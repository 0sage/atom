...
from atom.cli.gateway import create_gateway_app
from atom.config.schema import Config
from atom.gateway import GatewayStartOptions, GatewayStatus, RuntimeResult
from atom.gateway.service import GatewayServiceOptions, GatewayServiceResult
...
class FakeServiceInstaller:
    ...
    def install(self, options: GatewayServiceOptions, *, dry_run: bool) -> GatewayServiceResult:
        ...
        return GatewayServiceResult(
            ...
            "systemd",
            self.tmp_path / "atom-gateway.service",
...
def _test_app(
    ...
    def run_gateway(
        ...
        *,
        ...
        run_calls.append((config, port, unconfigured_provider_error))
...
def test_gateway_foreground_passes_recoverable_provider_error_to_runner(tmp_path):
    ...
    app, _runtime, _service, calls = _test_app(
        tmp_path,
...
def test_gateway_managed_start_allows_recoverable_provider_error(
    ...
    app, fake_runtime, _service, calls = _test_app(
        tmp_path,
