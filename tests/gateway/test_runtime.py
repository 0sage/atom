...
from atom.gateway import GatewayRuntime, GatewayRuntimePaths, GatewayStartOptions, GatewayStatus
...
def test_terminate_posix_tolerates_process_group_disappearing_before_sigkill(
    ...
    monkeypatch.setattr(
        "atom.process_runtime.os.getpgid",
        lambda _pid: 1234,
        raising=False,
    )
    ...
    monkeypatch.setattr("atom.process_runtime.os.killpg", fake_killpg, raising=False)
