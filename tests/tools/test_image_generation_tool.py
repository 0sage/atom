...
from atom.config.schema import ImageGenerationToolConfig, ProviderConfig
from atom.providers.image_generation import GeneratedImageResponse
...
async def test_generate_image_tool_stores_artifact_and_source_images(
    ...
    monkeypatch.setattr(
        "atom.agent.tools.image_generation.get_image_gen_provider",
    ...
    assert artifacts[0]["model"] == "gpt-image-1"
