...
from atom.agent.tools.cli_apps import CliAppsTool
from atom.agent.tools.context import RequestContext, ToolContext, request_context
from atom.agent.tools.filesystem import ReadFileTool, WriteFileTool
from atom.agent.tools.image_generation import ImageGenerationError, ImageGenerationTool
from atom.agent.tools.message import MessageTool
from atom.agent.tools.search import GrepTool
from atom.agent.tools.shell import ExecTool
from atom.agent.tools.spawn import SpawnTool
from atom.apps.cli.service import CliAppManager, CliAppsRuntimeConfig
from atom.config.schema import ImageGenerationToolConfig, ProviderConfig, ToolsConfig
...
async def test_cli_app_scope_controls_working_dir(
    ...
    monkeypatch.setattr("atom.apps.cli.service.get_runtime_subdir", lambda _name: data_dir)
    monkeypatch.setattr(
