...
from atom.agent.runner import AgentRunResult
...
from atom.security.workspace_access import build_workspace_scope
...
def test_subagent_prompt_explains_grouped_skill_paths(tmp_path):
    ...
    assert f"Atom's agent workspace: {agent_workspace.resolve()}" in prompt
