...
from atom.cli import onboard as onboard_wizard
from atom.cli.onboard import (
    _BACK_PRESSED,
...
from atom.config.schema import Config, ModelPresetConfig
...
class TestProviderChannelInfo:
    ...
    def test_get_provider_names_returns_dict(self):
        from atom.cli.onboard import _get_provider_names
    ...
    def test_get_channel_names_returns_dict(self):
        from atom.cli.onboard import _get_channel_names
    ...
    def test_get_provider_info_returns_valid_structure(self):
        from atom.cli.onboard import _get_provider_info
...
class TestValidateFieldConstraint:
    ...
    def test_returns_none_when_no_constraints(self):
        ...
        from atom.cli.onboard import _validate_field_constraint
    ...
    def test_real_send_max_retries_field(self):
        ...
        from atom.cli.onboard import _validate_field_constraint
        from atom.config.schema import ChannelsConfig
...
class TestChannelCommonRegistration:
    ...
    def test_channel_common_in_settings_sections(self):
        ...
        from atom.cli.onboard import _SETTINGS_SECTIONS
    ...
    def test_channel_common_getter_returns_channels(self):
        ...
        from atom.cli.onboard import _SETTINGS_GETTER
    ...
    def test_channel_common_setter_writes_channels(self):
        ...
        from atom.cli.onboard import _SETTINGS_SETTER
...
class TestApiServerRegistration:
    ...
    def test_api_server_setter_writes_api(self):
        ...
        config = Config()
        from atom.config.schema import ApiConfig
...
class TestMainMenuUpdate:
    ...
    def test_main_menu_hides_save_actions_until_needed(self):
        ...
        from atom.cli.onboard import _get_main_menu_choices
    ...
    def test_quick_start_provider_choices_include_all_chat_providers(self):
        ...
        for spec in PROVIDERS:
            if spec.name == "custom" or spec.is_transcription_only or spec.is_oauth:
                continue
        ...
        assert choices["Anthropic"] == "anthropic"
        assert choices["OpenAI"] == "openai"
    ...
    def test_quick_start_provider_choice_skips_advanced_prompts(self, monkeypatch):
        ...
        def fail_advanced_config(*_args, **_kwargs):
            raise AssertionError("Quick Start should not open advanced settings")
        ...
        monkeypatch.setattr(onboard_wizard, "_show_section_header", lambda *a, **kw: None)
        monkeypatch.setattr(onboard_wizard, "_select_with_back", lambda *a, **kw: "Groq")
        monkeypatch.setattr(onboard_wizard, "_input_text", lambda *a, **kw: "gsk-test")
        monkeypatch.setattr(
            onboard_wizard,
            "_input_model_with_autocomplete",
            lambda *a, **kw: "llama-3.3-70b-versatile",
        )
        monkeypatch.setattr(
            onboard_wizard,
            "questionary",
            SimpleNamespace(
                ...
                password=lambda *a, **kw: FakePrompt("ws-secret"),
            ),
        )
        monkeypatch.setattr(onboard_wizard, "_configure_pydantic_model", fail_advanced_config)
        ...
        assert config.providers.groq.api_base == "https://api.groq.com/openai/v1"
        assert config.agents.defaults.model_preset == "primary"
        assert config.model_presets["primary"].provider == "groq"
        assert config.model_presets["primary"].model == "llama-3.3-70b-versatile"
    ...
    def test_quick_start_provider_choice_asks_for_model_id(self, monkeypatch):
        ...
        assert model_prompts == [("Model ID", "", "groq")]
        assert config.providers.groq.api_key == "gsk-test"
        assert config.providers.groq.api_base == "https://api.groq.com/openai/v1"
        assert config.model_presets["primary"].provider == "groq"
    ...
    def test_quick_start_api_key_escape_returns_to_provider_choice(self, monkeypatch):
        ...
        config = Config()
        provider_answers = iter(["Groq", "OpenAI"])
        ...
        assert selected_providers == ["Groq", "OpenAI"]
    ...
    def test_quick_start_requires_api_key_before_setting_defaults(self, monkeypatch):
        ...
        assert config.providers.groq.api_key is None
        assert config.providers.groq.api_base is None
    ...
    def test_quick_start_summary_calls_out_missing_api_key(self, monkeypatch):
        ...
        assert rows["Status"] == "Groq API key missing"
        assert rows["Model"] == "groq/llama-3.3-70b-versatile"
    ...
    def test_main_menu_dispatch_includes_channel_common(self):
        ...
        from atom.cli.onboard import _SETTINGS_GETTER, _SETTINGS_SECTIONS, _SETTINGS_SETTER
...
class TestIsStrOrNone:
    ...
    def test_str_or_none_true(self):
        from atom.cli.onboard import _is_str_or_none
...
class TestModelPresetWizard:
    ...
    def test_sync_preset_cache(self):
        ...
        from atom.cli.onboard import _MODEL_PRESET_CACHE, _sync_preset_cache
        from atom.config.schema import ModelPresetConfig
    ...
    def test_model_preset_add(self, monkeypatch):
        ...
        from atom.cli.onboard import _MODEL_PRESET_CACHE, _configure_model_presets
        from atom.config.schema import ModelPresetConfig
    ...
    def test_model_preset_field_handler(self, monkeypatch):
        ...
        from atom.cli.onboard import _MODEL_PRESET_CACHE, _handle_model_preset_field
        from atom.config.schema import AgentDefaults
    ...
    def test_main_menu_dispatch_includes_model_presets(self):
        ...
        from atom.cli.onboard import _configure_model_presets
    ...
    def test_fallback_models_field_add(self, monkeypatch):
        ...
        from atom.cli.onboard import _MODEL_PRESET_CACHE, _handle_fallback_models_field
        from atom.config.schema import AgentDefaults
    ...
    def test_provider_field_handler(self, monkeypatch):
        ...
        from atom.cli.onboard import _handle_provider_field
        from atom.config.schema import AgentDefaults
    ...
    def test_search_provider_field_handler(self, monkeypatch):
        ...
        from atom.agent.tools.web import WebSearchConfig
        from atom.cli.onboard import _handle_search_provider_field
