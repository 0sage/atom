...
from atom.agent.hook import CompositeHook
from atom.agent.hooks import FileEditActivityHook
from atom.agent.progress_hook import AgentProgressHook
from atom.agent.runner import AgentRunner
from atom.agent.tools.filesystem import EditFileTool, WriteFileTool
...
async def test_runner_routes_hosted_tool_events_to_structured_progress():
    ...
    assert progress_text == ['search X "atom oauth"', "", "done"]
    provider.chat_with_retry.assert_not_awaited()
