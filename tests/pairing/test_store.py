...
from atom.pairing import __all__ as pairing_all
from atom.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from atom.pairing."""
    import atom.pairing as pkg
...
class TestFormatPairingReply:
    def test_points_owner_to_approval_command(self) -> None:
