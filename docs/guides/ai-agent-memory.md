# How AI Agent Memory Works in atom

This guide explains how to use atom's long-term AI agent memory: session
...
ground for every raw transcript; atom separates short-term messages from
...
- [AI Agent Memory in atom](../memory.md)
