# How to Configure Model Fallback in atom

Model fallback lets atom try a primary model first, then fall back to one or
...
Merge this shape into `~/.atom/config.json` and replace provider/model names
