...
| Run a long-running agent | [Long-running AI agent](./long-running-ai-agent.md) |
| Add long-term memory | [AI agent memory](./ai-agent-memory.md) |

## Connect a Chat App

These guides explain the account, bot, token, permission, and test-message steps for Telegram, the chat channel atom ships with.
...
| Deploy the gateway | [Deploy atom gateway](./deploy-atom-gateway.md) |
