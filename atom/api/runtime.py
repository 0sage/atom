"""Background process control for the OpenAI-compatible API server."""
...
from atom.process_runtime import (
...
class ApiStartOptions(ProcessStartOptions):
    """Options needed to start a managed ``atom serve`` process."""
...
class ApiRuntime(ManagedProcessRuntime[ApiStartOptions]):
    """Manage a background OpenAI-compatible API process."""
