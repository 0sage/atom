"""OpenAI-compatible HTTP API server for a fixed atom session.
...
from atom.utils.helpers import safe_filename
from atom.utils.media_decode import (
    MAX_FILE_SIZE,
)
from atom.utils.media_decode import (
...
from atom.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE
...
async def handle_chat_completions(request: web.Request) -> web.Response | web.StreamResponse:
    ...
    model_name: str = _app_value(request.app, _MODEL_NAME_KEY, "model_name", "atom")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = _app_value(request.app, _MODEL_NAME_KEY, "model_name", "atom")
    return web.json_response(
        {
            "object": "list",
            "data": [
