...
This module only knows how to call external transcription APIs: Groq Whisper
and OpenAI Whisper. Product-level config fallback, upload validation, and
channel integration live in ``atom.audio.transcription``.
"""
