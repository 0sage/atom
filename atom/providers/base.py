...
from atom.utils.helpers import sanitize_surrogates_deep

STREAM_IDLE_TIMEOUT_ENV = "ATOM_STREAM_IDLE_TIMEOUT_S"
...
class LLMProvider(ABC):
    ...
    def _sanitize_empty_content(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        surrogates (e.g. leaking from console input, prompt_toolkit history,
