...
from atom.config.schema import Config, InlineFallbackConfig, ModelPresetConfig, ProviderConfig
from atom.providers.base import GenerationSettings, LLMProvider
from atom.providers.fallback_provider import FallbackProvider
from atom.providers.registry import ProviderSpec, create_dynamic_spec, find_by_name
...
def build_unconfigured_provider_snapshot(config: Config, setup_error: str) -> ProviderSnapshot:
    """Build a non-networking runtime for use before first-time setup completes."""
