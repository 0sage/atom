...
from atom.agent.hook import AgentHook, AgentHookContext, AgentRunHookContext
...
from atom.providers.conversation_state import (
    ...
    async def _request_model(
        ...
        *,
        ...
        if timeout_s is None:
            ...
            # Set ATOM_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("ATOM_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (ATOM_STREAM_IDLE_TIMEOUT_S), but a stream that keeps producing
        # very slow deltas can still run forever. Use a more generous wall-clock
        # timeout for streaming while preserving ATOM_LLM_TIMEOUT_S=0 as an
