...
from atom.runtime_context import public_history_messages
from atom.session.manager import MIN_COMPACTED_REPLAY_MESSAGES, Session, SessionManager
from atom.utils.gitstore import GitStore
...
from atom.utils.workspace_prompts import (
...
class MemoryStore:
    ...
    def _write_entries(self, entries: list[dict[str, Any]]) -> None:
        ...
        try:
            ...
            # fsync the directory so the rename is durable. Tolerate
            # filesystems that refuse to open a directory for reading.
