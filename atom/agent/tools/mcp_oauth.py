...
_CLIENT_URI = AnyHttpUrl("https://github.com/0sage/atom")
_LOGO_URI = AnyHttpUrl(
    "https://raw.githubusercontent.com/0sage/atom/main/images/atom_logo.png"
)
...
async def create_mcp_oauth_auth(
    ...
    metadata = OAuthClientMetadata(
        ...
        logo_uri=_LOGO_URI,
        software_id="https://github.com/0sage/atom",
    )
