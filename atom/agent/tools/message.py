...
from atom.agent.tools.context import ToolContext, current_request_context
from atom.agent.tools.path_utils import resolve_workspace_path
from atom.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from atom.bus.events import OutboundMessage
from atom.config.paths import get_workspace_path
...
@tool_parameters(
    tool_parameters_schema(
        ...
        chat_id=StringSchema(
            ...
            "Omit it to use the current conversation id from context. "
...
class MessageTool(Tool):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from atom.utils.helpers import strip_think
