...
from atom.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path
from atom.utils.artifacts import (
    ArtifactError,
...
class ImageGenerationTool(Tool):
    ...
    def __init__(
        ...
        *,
        ...
        if provider_config is not None and "openai" not in self.provider_configs:
            self.provider_configs["openai"] = provider_config
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        try:
            ...
            raise ImageGenerationError(
                "reference_images must be inside the workspace or atom media directory"
            ) from exc
...
async def reload_image_generation_tool(state: Any, registry: ToolRegistry) -> dict[str, Any]:
    ...
    return {
        "ok": True,
        "message": "Image generation settings applied without restarting atom.",
