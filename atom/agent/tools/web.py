...
from atom.utils.helpers import build_image_content_blocks
...
def _fetch_client_kwargs(proxy: str | None, timeout: float) -> dict[str, Any]:
    from atom.security.network import httpx_env_proxy_mounts
...
def _unsafe_url_request_error(exc: BaseException) -> str | None:
    from atom.security.network import UnsafeURLRequestError
    ...
    async def _search_olostep(self, query: str, n: int) -> str:
        try:
            ...
            return ToolResult.error(
                ...
                "Run `atom plugins enable olostep`."
            )
