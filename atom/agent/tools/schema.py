"""JSON Schema fragment types: all subclass :class:`~atom.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~atom.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~atom.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~atom.agent.tools.base.Schema`.
...
from atom.agent.tools.base import Schema
