...
from atom.agent.tools.file_state import FileStates, _hash_file, current_file_states
from atom.agent.tools.path_utils import resolve_workspace_path
...
from atom.security.workspace_access import current_tool_workspace
from atom.utils.helpers import build_image_content_blocks, detect_image_mime
...
class _FsTool(Tool):
    ...
    def _resolve_read(self, path: str) -> Path:
        ...
        if self._workspace is not None:
            from atom.agent.plugins import enabled_agent_plugin_skill_dirs
...
class ReadFileTool(_FsTool):
        ...
        **kwargs: Any,
        ...
        try:
            ...
            try:
                ...
                from atom.utils.document import _is_text_extension
            ...
            # Normalize CRLF -> LF before line-splitting. CRLF files still turn
            # up on POSIX (git checkouts with autocrlf, editors saving CRLF),
            # so this is applied unconditionally to keep StrReplace/Grep
            # behavior consistent regardless of where the file was written.
    ...
    def _read_pdf(self, fp: Path, pages: str | None) -> str:
        from atom.utils.document import PdfPageRangeError, PdfSafetyError, extract_pdf_pages
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from atom.utils.document import extract_text
