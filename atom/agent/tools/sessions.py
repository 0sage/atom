...
from atom.agent.tools.schema import StringSchema, tool_parameters_schema
from atom.session.manager import SessionManager
from atom.session.session_access import SessionAccess
...
class _SessionTool(Tool):
    def __init__(self, sessions: SessionManager) -> None:
        self._access = SessionAccess(sessions)
