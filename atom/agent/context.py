...
from atom.agent.tools import image_generation as image_generation_tools
from atom.agent.tools import mcp as mcp_tools
from atom.agent.tools import sessions as session_tools
from atom.agent.tools.registry import ToolRegistry
from atom.apps.cli import utils as cli_app_utils
from atom.bus.events import (
...
from atom.utils.helpers import (
    detect_image_mime,
    load_bundled_template,
    truncate_text_to_tokens,
)
from atom.utils.prompt_templates import render_template
    ...
    def _load_bootstrap_files(self, workspace: Path | None = None) -> str:
        ...
        for filename, root in sources:
            ...
            if file_path.exists():
                ...
                # legacy/SOUL.md is a byte-exact fingerprint of the historical
                # template, matched against SOUL.md files already on disk. It
                # must keep its original wording -- including the cat -- or
                # untouched old workspaces stop being recognized as unmodified.
