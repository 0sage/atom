...
from atom.cli.log_control import _set_atom_logs
from atom.cli.runtime_config import (
    _load_runtime_config,
    _migrate_cron_store,
    _model_display,
    _print_agent_start_error,
)
from atom.cli.stream import StreamRenderer, ThinkingSpinner
...
def agent(
    ...
    logs: bool = typer.Option(
        False,
        "--logs/--no-logs",
        help="Show atom runtime logs during chat",
    ),
):
