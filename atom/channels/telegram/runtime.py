...
from atom.utils.helpers import split_message
...
# python-telegram-bot exposes a six-parameter Application generic. Atom
...
class TelegramChannel(BaseChannel):
    ...
    def _queue_key_for_message(message: Message) -> str:
        """Return the final atom session key used for ordered Telegram ingress."""
