...
class BaseChannel(ABC):
    ...
    to integrate with the atom message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            from atom.audio.transcription import (
    ...
    async def send_reasoning_delta(
        ...
        *,
        ...
        (Telegram expandable blockquote, ...) override to render reasoning
