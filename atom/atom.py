"""High-level programmatic interface to atom."""
...
from atom.agent.hook import AgentHook, SDKCaptureHook
...
from atom.sdk.clients import MemoryClient, RuntimeClient, SessionClient
from atom.sdk.runtime import (
    build_process_direct_kwargs,
    ensure_single_model_selector,
)
from atom.sdk.streaming import RunStream, SDKStreamEmitter, SDKStreamingHook
from atom.sdk.types import (
...
class Atom:
    """Programmatic facade for running the atom agent.
        ...
        *,
        ...
        Args:
            ...
            attributes: Optional caller-owned request data exposed to context
                ...
                from atom's trusted internal message metadata.
    ...
    async def __aenter__(self) -> Atom:
        return self
