...
from atom.utils.run_records import (
...
class CronService:
    ...
    def _atomic_write(path: Path, content: str) -> None:
        ...
        Mirrors ``atom.session.manager.SessionManager.save`` (see
        ...
        try:
            ...
            # and restricted mounts can deny the open with PermissionError.
