...
Persistent storage at ``~/.atom/pairing.json`` keeps approved senders
...
def format_pairing_reply(code: str) -> str:
    ...
    return (
        ...
        "To get access, ask the owner to approve this request by sending\n"
        f"`/pairing approve {code}` to the assistant."
    )
