...
Provider-specific HTTP adapters live in ``atom.providers.transcription``.
...
TRANSCRIPTION_PROVIDERS: tuple[TranscriptionProviderSpec, ...] = (
    TranscriptionProviderSpec(
        ...
        adapter="atom.providers.transcription:GroqTranscriptionProvider",
    ),
    TranscriptionProviderSpec(
        name="openai",
        default_model="whisper-1",
        adapter="atom.providers.transcription:OpenAITranscriptionProvider",
    ),
)
